...
if(isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO players (id, name, age, position, team_id) VALUES (NULL, '$name', '$age', '$position', '$team')";
...
<form class="w-full max-w-lg justify-center items-center" method="post">
    ...
    <button class="bg-black text-white p-5 rounded-md" name="submit" type="submit">Create Player</button>
</form>
</body>
</html>
